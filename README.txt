...
apache: It contains the recipe to install apache httpd-tools-2.2.31-1.el6.x86_64.rpm and its dependent softwares from network YUM respository.
It will create-
1) A YUM Repository Configuration file which is pointing to one of the server in network
2) Virtual Host with template 
3) Document root direcory
4) A static page 
